...
<div id="container"><!-- Start container -->
	...
	<div id="contentContainer"><!-- Start main content wrapper -->
		<div id="content"><!-- Start content -->
			<strong>Welcome to my code studio!</strong><br /><br /><br />This is the my test appengine sandbox. Please be kind.<br /><br /><img class="imageStyle" alt="DSC_4151" src="files/dsc_4151.jpg" width="480" height="319"/>
		</div><!-- End content -->
